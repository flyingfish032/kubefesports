...
const MatchesPage = () => {
  ...
  const fetchMatches = async () => {
    try {
      const response = await axios.get("http://localhost:30083/back1/api/matches");
  ...
  const fetchTeams = async () => {
    try {
      const response = await axios.get("http://localhost:30083/back1/api/teams");
  ...
  const createMatch = async () => {
    ...
    try {
      await axios.post("http://localhost:30083/back1/api/matches", {
