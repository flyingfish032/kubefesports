...
const TeamsPage = () => {
    ...
    const addTeam = () => {
        ...
        axios.post("http://localhost:30083/back1/api/teams", teamData)
            .then((response) => {
    ...
    const deleteTeam = (id) => {
        axios.delete(`http://localhost:30083/back1/api/teams/${id}`)
            .then(() => {
    ...
    const saveEdit = () => {
        ...
        axios.put(`http://localhost:30083/back1/api/teams/${updatedTeam.id}`, updatedTeam)
            .then((response) => {
